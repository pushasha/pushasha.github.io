<contact-section>
    <section id="contact" class="contact-area section-gap">
        <div class="container">
            ...
            <form class="form-area mt-60 text-right" id="myForm" action="https://formspree.io/splotkin@gmail.com" method="post">
                <div class="row">
